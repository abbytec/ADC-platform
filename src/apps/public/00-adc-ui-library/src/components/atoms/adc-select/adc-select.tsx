	...
	render() {
		return (
			<div class="w-full">
				<button
					type="button"
					class="w-full px-3 py-2 rounded-xxl border border-alt bg-white text-text text-[12px] font-text flex justify-between items-center"
					aria-haspopup="menu"
				...
				{this.isOpen && (
					<div class="mt-1 bg-white border border-alt rounded-xxl shadow-cozy max-h-60 overflow-auto w-full">
						{this.options.map((option) => (
							<button
								type="button"
								class="px-3 py-1 cursor-pointer hover:bg-alt w-full text-left"
								role="menuitem"

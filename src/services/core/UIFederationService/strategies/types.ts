...
/**
 * Información de un framework soportado
 */
export interface FrameworkInfo {
	/** Identificador del framework (ej: "react", "vite-react") */
	id: string;
	/** Nombre descriptivo */
	displayName: string;
	/** Bundler usado */
...
/**
 * Opciones de configuración para builders
 */
export interface BuilderOptions {
	/** Modo de producción vs desarrollo */
	...
	/** Es un host (layout) */
	isHost: boolean;
	/** Tiene i18n habilitado */
	hasI18n: boolean;
	/** Tiene Tailwind habilitado */
	hasTailwind: boolean;
}

/**
 * Configuración de Module Federation para remotes
 */
export interface RemoteConfig {
	...
	/** URL del manifest */
	url: string;
	/** Framework del remote */
	framework: string;
}

/**
 * Configuración de shared libraries para Module Federation
 */

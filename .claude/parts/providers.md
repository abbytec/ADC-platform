...
### express-server
Servidor Express tradicional. Usado automáticamente en modo desarrollo (`npm run start:dev`).
...
- `npm run start:dev` → puerto 3000 (con dev servers en puertos separados)
